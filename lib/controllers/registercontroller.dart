...
class RegistrationController extends GetxController {
  ...
  Future<void> registerUser(String uname, String email, String phoneNumber,
      String uPassword, String uRePassword, bool agreedToBeSupplied) async {
    ...
    http.Response response = await http.post(myLogin, headers: {
      ...
      "user_type": "Customer",
      "agreed_to_supplied": agreedToBeSupplied
    });
