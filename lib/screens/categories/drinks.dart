    ...
    return Scaffold(
        ...
        body: GetBuilder<StoreItemsController>(builder: (controller) {
          return ListView.builder(
              itemCount: controller.allDrinks != null
                  ? controller.allDrinks.length
                  : 0,
              itemBuilder: (context, index) {
                items = controller.allDrinks[index];
                return GestureDetector(
                  onTap: () {
                    Get.to(() => DetailPage(
                        id: controller.allDrinks[index]['id'].toString()));
                  },
                  child: Card(
                                  ...
                                  return IconButton(
                                    onPressed: () {
                                      cController.addToCart(
                                          uToken,
                                          controller.allDrinks[index]['id']
                                              .toString(),
                                          "1",
                                          controller.allDrinks[index]
                                                  ['new_price']
                                              .toString());
                                    },
