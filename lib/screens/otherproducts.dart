...
class AllOthers extends StatefulWidget {
  const AllOthers({super.key});

  @override
  State<AllOthers> createState() => _AllOthersState();
}

class _AllOthersState extends State<AllOthers> {
  var items;
                                  ...
                                  return IconButton(
                                    onPressed: () {
                                      cController.addToCart(
                                          uToken,
                                          controller.otherItems[index]['id']
                                              .toString(),
                                          "1",
                                          controller.otherItems[index]
                                                  ['new_price']
                                              .toString());
                                    },
